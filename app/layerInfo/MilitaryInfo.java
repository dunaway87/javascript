...
public class MilitaryInfo {
	...
	public static String getMiliteryInfo(double lat, double lng) throws SQLException{
    	...
    	ResultSet results = conn.prepareStatement("Select \"NAME\" from military where ST_CONTAINS(ST_Transform(my_geom, 4326),ST_SETSRID(ST_POINT("+lng+", "+lat+"), 4326))  limit 1").executeQuery();
    	try{
    		results.next();
        	html = "<fieldset><strong>Military Base</strong>";
    		addLineToHtml("Name", results.getString(1));
