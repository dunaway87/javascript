...
public class AvyInfo {
	public static String html;
	public static String getAvyInfo(double lat, double lng) throws SQLException{
    	...
    	ResultSet results = conn.prepareStatement("Select \"HAZARD\" from avalanche where ST_CONTAINS(ST_Transform(my_geom, 4326),ST_SETSRID(ST_POINT("+lng+", "+lat+"), 4326))  limit 1").executeQuery();
    	try{
    		results.next();
        	html = "<fieldset><strong>Avalanche Info</strong>";
    		addLineToHtml("Hazard", results.getString(1));
